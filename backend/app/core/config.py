...
TALENT_POOL_SHORTLIST_THRESHOLD = float(os.getenv("TALENT_POOL_SHORTLIST_THRESHOLD", "40"))
...
# DIAG: Temporarily lowered to 0.01 for end-to-end pipeline diagnostics (was 0.60)
INTERNAL_CANDIDATE_MATCH_THRESHOLD = float(os.getenv("INTERNAL_CANDIDATE_MATCH_THRESHOLD", "0.01"))
