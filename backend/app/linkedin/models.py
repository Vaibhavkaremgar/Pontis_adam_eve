...
class LinkedInAccountEntity(Base):
    ...
    company_id: Mapped[str] = mapped_column("agency_id", GUID(), ForeignKey("agencies.id"), nullable=False)
    agency_id: Mapped[str] = synonym("company_id")
    display_name: Mapped[str] = mapped_column(String(255), nullable=False, default="")
    linkedin_email: Mapped[str] = mapped_column(String(320), nullable=False, default="")
...
class LinkedInJobEntity(Base):
    ...
    account_id: Mapped[str] = mapped_column(GUID(), ForeignKey("linkedin_accounts.id"), nullable=False)
...
class LinkedInConversationEntity(Base):
    ...
    conversation_status: Mapped[str] = mapped_column(String(32), nullable=False, default="unknown")
...
class LinkedInMessageEntity(Base):
    ...
    id: Mapped[str] = mapped_column(GUID(), primary_key=True)
    conversation_id: Mapped[str] = mapped_column(GUID(), ForeignKey("linkedin_conversations.id"), nullable=False)
    candidate_id: Mapped[str] = mapped_column(String(128), nullable=False)
    sender_type: Mapped[str] = mapped_column(String(32), nullable=False, default="system")
...
class LinkedInAttachmentEntity(Base):
    ...
    id: Mapped[str] = mapped_column(GUID(), primary_key=True)
    message_id: Mapped[str] = mapped_column(GUID(), ForeignKey("linkedin_messages.id"), nullable=False)
    candidate_id: Mapped[str] = mapped_column(String(128), nullable=False)
    ...
    downloaded_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True, default=None)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=_utc_now, nullable=False)
