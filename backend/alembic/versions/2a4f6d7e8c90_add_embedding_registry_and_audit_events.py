...
def upgrade() -> None:
    ...
    if not _table_exists("embedding_version_registry"):
        op.create_table(
    ...
    if not _index_exists("ix_embedding_version_registry_embedding_version"):
    ...
    if not _index_exists("ix_audit_events_actor_id"):
        op.create_index("ix_audit_events_actor_id", "audit_events", ["actor_id"])
    if not _index_exists("ix_audit_events_action"):
        op.create_index("ix_audit_events_action", "audit_events", ["action"])
    if not _index_exists("ix_audit_events_entity_type"):
        op.create_index("ix_audit_events_entity_type", "audit_events", ["entity_type"])
    if not _index_exists("ix_audit_events_entity_id"):
